...
class ActivitesCollection extends ArrayCollection implements Selectable
{
    protected $class;
    ...
    public function __construct(array $elements,$class)
    {
        ...
        foreach ($elements as $element){
            if($element instanceof \stdClass) {
                $datas[$element->nom] = $serializer->deserialize(json_encode($element), $class, "json");
            }else{
                $datas[$element->getNom()] = $element;
            }
        }
